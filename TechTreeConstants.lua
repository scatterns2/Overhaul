...
kTechId = createTechIdEnum({
    ...
    -- Weapon tech
    'AdvancedWeaponry', 'ShotgunTech', 'HeavyRifleTech', 'HeavyMachineGunTech', 'DetonationTimeTech', 'FlamethrowerRangeTech', 'GrenadeLauncherTech', 'FlamethrowerTech', 'FlamethrowerAltTech', 'WelderTech', 'MinesTech',
	...
	'ShieldpackMarine','ShieldpackTech','Shieldpack','DropShieldpack','EquipmentMenu','ShieldCapacityTech','ShieldRechargeTech','SentryArmorTech','SentryDamageTech',
