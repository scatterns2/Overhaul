...
function Alien:GetArmorAmount()
    ...
    elseif GetHasCelerityUpgrade(self) then
        return self:GetArmorFullyUpgradedAmount()		
	elseif GetHasCarapaceUpgrade(self) and GetHasCelerityUpgrade(self) then
		return self:GetCombinedArmor()
	end
...
function Alien:UpdateArmorAmount()
	...
	if GetHasCarapaceUpgrade(self) and not GetHasCelerityUpgrade(self) then
		newMaxArmor =  self:GetArmorFullyUpgradedAmount()  
	elseif GetHasCelerityUpgrade(self) and not GetHasCarapaceUpgrade(self) then
		newMaxArmor =  self:GetCelerityArmorReduction() 
	elseif GetHasCarapaceUpgrade(self) and GetHasCelerityUpgrade(self) then
		newMaxArmor =  self:GetArmorCombinedAmount()
	else 
		newMaxArmor = self:GetBaseArmor()
	end	
...
function Alien:GetCelerityArmorReduction()
    return kCelerityArmorReduction
end
...
function Alien:GetCarapaceMovementScalar()
    ...
    if GetHasCarapaceUpgrade(self) then
        return self:GetCarapaceSpeedReduction()    
    end
...
function Alien:GetCelerityArmorScalar()

    if GetHasCelerityUpgrade(self) then
        return self:GetCelerityArmorReduction()   
    end
...
function Alien:GetArmorCombinedAmount()
    assert(false)
end
