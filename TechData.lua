...
function BuildTechData()
    ...
    local techData = {
        ...
        { [kTechDataId] = kTechId.ShieldpackMarine,   [kTechDataHint] = "SHIELDPACK_HINT",    [kTechDataDisplayName] = "SHIELDPACK", [kTechDataMapName] = ShieldpackMarine.kMapName, [kTechDataModel] = ShieldpackMarine.kModelName, [kTechDataMaxExtents] = Vector(Player.kXZExtents, Player.kYExtents, Player.kXZExtents), [kTechDataMaxHealth] = Marine.kHealth, [kTechDataEngagementDistance] = kPlayerEngagementDistance, [kTechDataPointValue] = kMarinePointValue},
        ...
        { [kTechDataId] = kTechId.EquipmentMenu,           [kTechDataDisplayName] = "EQUIPMENT_MENU", [kTechDataTooltipInfo] = "EQUIPMENT_MENU_TOOLTIP"},
        ...
        { [kTechDataId] = kTechId.DropShieldpack,   [kTechDataMapName] = Shieldpack.kMapName, [kTechDataDisplayName] = "SHIELDPACK", [kTechIDShowEnables] = false, [kTechDataTooltipInfo] =  "SHIELDPACK_TOOLTIP", [kTechDataModel] = Shieldpack.kModelName, [kTechDataCostKey] = kShieldpackDropCost, [kStructureAttachId] = kTechId.PrototypeLab, [kStructureAttachRange] = kArmoryWeaponAttachRange, [kStructureAttachRequiresPower] = true },
        ...
        { [kTechDataId] = kTechId.Shieldpack,   [kTechDataMapName] = Shieldpack.kMapName,                   [kTechDataDisplayName] = "SHIELDPACK", [kTechDataModel] = Shieldpack.kModelName, [kTechDataCostKey] = kShieldpackCost, [kTechDataSpawnHeightOffset] = kCommanderEquipmentDropSpawnHeight },
        { [kTechDataId] = kTechId.ShieldpackTech,    [kTechDataCostKey] = kShieldpackTechResearchCost,               [kTechDataResearchTimeKey] = kShieldpackTechResearchTime,     [kTechDataDisplayName] = "SHIELDPACK_TECH" },
        ...
        { [kTechDataId] = kTechId.ShieldCapacityTech,       [kTechDataCostKey] = kShieldCapacityTechResearchCost,         [kTechDataResearchTimeKey] = kShieldCapacityTechResearchTime,     [kTechDataDisplayName] = "SHIELD_CAPACITY_TECH", [kTechDataImplemented] = true, [kTechDataHotkey] = Move.S, [kTechDataTooltipInfo] = "SHIELD_CAPACITY_TOOLTIP"},
        { [kTechDataId] = kTechId.ShieldRechargeTech,       [kTechDataCostKey] = kShieldRechargeTechResearchCost,         [kTechDataResearchTimeKey] = kShieldRechargeTechResearchTime,     [kTechDataDisplayName] = "SHIELD_RECHARGE_TECH", [kTechDataImplemented] = true, [kTechDataHotkey] = Move.S, [kTechDataTooltipInfo] = "SHIELD_RECHARGE_TOOLTIP"},
		{ [kTechDataId] = kTechId.SentryArmorTech,       [kTechDataCostKey] = kSentryArmorTechResearchCost,         [kTechDataResearchTimeKey] = kSentryArmorTechResearchTime,     [kTechDataDisplayName] = "SENTRY_ARMOR_TECH", [kTechDataImplemented] = true, [kTechDataHotkey] = Move.S, [kTechDataTooltipInfo] = "SENTRY_ARMOR_TOOLTIP"},
        { [kTechDataId] = kTechId.SentryDamageTech,       [kTechDataCostKey] = kSentryDamageTechResearchCost,         [kTechDataResearchTimeKey] = kSentryDamageTechResearchTime,     [kTechDataDisplayName] = "SENTRY_DAMAGE_TECH", [kTechDataImplemented] = true, [kTechDataHotkey] = Move.S, [kTechDataTooltipInfo] = "SENTRY_DAMAGE_TOOLTIP"},
