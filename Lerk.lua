...
function Lerk:GetCelerityArmorReduction()
    return kLerkCelerityArmorReduction
end
...
function Lerk:GetArmorCombinedAmount()
    return kLerkCombinedArmor 
end
...
function Lerk:ModifyCelerityBonus(celerityBonus)
