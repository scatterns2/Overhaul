...
local function GetIsEquipment(techId)
    ...
    return techId == kTechId.DropWelder or techId == kTechId.DropMines or techId == kTechId.DropShotgun or techId == kTechId.DropHeavyMachineGun or techId == kTechId.DropGrenadeLauncher or
           techId == kTechId.DropFlamethrower or techId == kTechId.DropJetpack or techId == kTechId.DropExosuit or techId == kTechId.DropShieldpack
...
function MarineCommander:TriggerPowerSurge(position, entity, trace)
    ...
    local distance = 1000 --FIXME This seems, excessive...
