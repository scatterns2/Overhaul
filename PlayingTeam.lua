...
local function GetIsResearchRelevant(techId)
    ...
    if not relevantResearchIds then
        ...
        relevantResearchIds[kTechId.ShieldpackTech] = 3
        relevantResearchIds[kTechId.ShieldCapacityTech] = 3
        relevantResearchIds[kTechId.ShieldRechargeTech] = 3
		...
		relevantResearchIds[kTechId.SentryArmorTech] = 3
        relevantResearchIds[kTechId.SentryDamageTech] = 3      
...
function PlayingTeam:Update(timePassed)
    ...
    local warmupActive = GetGamerules():GetWarmUpActive()
