...
kJetpackingAccel = 2.5
kJetpackUseFuelRate = 1.0
kJetpackReplenishFuelRate = 0.33
...
kCarapaceSpeedReduction = 0
kSkulkCarapaceSpeedReduction = 1.5 --0.2758 --0.08
kGorgeCarapaceSpeedReduction = 1.5 --0.08
kLerkCarapaceSpeedReduction = 1.5 --0.15
kFadeCarapaceSpeedReduction = 1.5 --0.15
kOnosCarapaceSpeedReduction = 1.5 --0.12
